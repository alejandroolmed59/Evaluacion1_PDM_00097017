...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mButton.setOnClickListener(View.OnClickListener {
            ...
            intent.putExtra("1", arraydeContadores.get(1).toString())
            intent.putExtra("2", arraydeContadores.get(2).toString())
            intent.putExtra("3", arraydeContadores.get(3).toString())
            intent.putExtra("4", arraydeContadores.get(4).toString())
            intent.putExtra("5", arraydeContadores.get(5).toString())
            intent.putExtra("6", arraydeContadores.get(6).toString())
            intent.putExtra("7", arraydeContadores.get(7).toString())
            intent.putExtra("8", arraydeContadores.get(8).toString())
            intent.putExtra("9", arraydeContadores.get(9).toString())
